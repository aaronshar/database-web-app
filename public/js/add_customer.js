...
addPersonForm.addEventListener("submit", function (e) {
    ...
    let inputFirstName = document.getElementById("input-customer-firstname");
    let inputLastName = document.getElementById("input-customer-lastname");
    let inputStreet = document.getElementById("input-customer-street");
    let inputCity = document.getElementById("input-customer-city");
    let inputState = document.getElementById("input-customer-state");
    let inputZipCode = document.getElementById("input-customer-zipcode");
    let inputEmail = document.getElementById("input-customer-email");
